...
public class Commande implements Serializable {
	...
	public Commande(String commande){
		...
		String[] str = commande.split("#"); //Séparation de la commande en fonction du caractère #
		nb_args = str.length;
		if((str[0].equals("compilation"))&&(nb_args == 3)){ //Si le premier terme est "compilation", je récupère les valeurs
			...
			String[] source = str[1].split(","); //Séparation de la commande en fonction du caractère ,
			for(int i = 0; i < 2; i++){
			...
			if(nb_args == 4){
				String[] param = str[3].split(","); //Séparation de la commande en fonction du caractère ,
				nb_param = param.length;
				for(int i = 0; i < nb_param; i++){ //Boucle en fonction du nombre de paramètres contenu dans la liste
					String[] tampon = param[i].split(":"); //Séparation de la commande en fonction du caractère :
